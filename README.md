[oak-examples中文文档](README.zh-CN.md)
# oak-examples
...
The following list isn't exhaustive (as we randomly add examples and we may forget to update this list):

## Gaze Estimation ([here](https://github.com/luxonis/oak-examples/tree/master/gen2-gaze-estimation#gen2-gaze-estimation))

[![Gaze Example Demo](https://github.com/luxonis/oak-examples/assets/18037362/6c7688e5-30bc-4bed-8455-8b8e9899c5b0)

## Age and Gender Recognition ([here](https://github.com/luxonis/oak-examples/tree/master/gen2-age-gender#gen2-age--gender-recognition))
...
## Automated Face-Blurring ([here](https://github.com/luxonis/oak-examples/tree/master/gen2-blur-faces#gen2-blur-faces-in-real-time))

![Blur Face](https://user-images.githubusercontent.com/18037362/139135932-b907f037-9336-4c42-a479-5715d9693c9c.gif)

## Spatial Calculation - On Host to Show/Explain Math That Happens in OAK-D for the Spatial Location Calculator ([here](https://github.com/luxonis/oak-examples/tree/master/gen2-calc-spatials-on-host#calculate-spatial-coordinates-on-the-host))
...
![demo](https://github.com/luxonis/oak-examples/blob/master/gen2-multiple-devices/spatial-detection-fusion/img/demo.gif?raw=true)

## Stereo Depth from Camera and From Host ([here](https://github.com/luxonis/oak-examples/tree/master/gen2-camera-demo#gen2-camera-demo))

![image](https://user-images.githubusercontent.com/32992551/99454609-e59eaa00-28e3-11eb-8858-e82fd8e6eaac.png)

## Automatic JPEG Encoding and Saving Based on AI Results ([here](https://github.com/luxonis/oak-examples/tree/master/gen2-class-saver-jpeg#gen2-class-saver-jpeg))
...
## Face Mask Detection ([here](https://github.com/luxonis/oak-examples/tree/master/gen2-coronamask))
...
## Crowd Counting ([here](https://github.com/luxonis/oak-examples/tree/master/gen2-crowdcounting#gen2-crowd-counting-with-density-maps-on-depthai))

![Image example](https://raw.githubusercontent.com/luxonis/oak-examples/master/gen2-crowdcounting/imgs/example.gif)

## Cumulative Object Counting ([here](https://github.com/luxonis/oak-examples/tree/master/gen2-cumulative-object-counting#cumulative-object-counting))
...
## How to Run Customer CV Models On-Device ([here](https://github.com/luxonis/oak-examples/tree/master/gen2-custom-models#demos))
...
## Semantic Segmentation of Depth ([here](https://github.com/luxonis/oak-examples/tree/master/gen2-deeplabv3_depth#gen2-deeplabv3-on-depthai---depth-cropping))

![Deeplabv3 Depth GIF](https://user-images.githubusercontent.com/59799831/132396685-c494f21b-8101-4be4-a787-dd382ae6b470.gif)

## Multi-Class Semantic Segmentation ([here](https://github.com/luxonis/oak-examples/tree/master/gen2-deeplabv3_multiclass#gen2-deeplabv3-multiclass-on-depthai))

![Multi-class Semantic Segmentation](https://raw.githubusercontent.com/luxonis/oak-examples/master/gen2-deeplabv3_multiclass/imgs/example.gif)

## Depth-Driven Focus ([here](https://github.com/luxonis/oak-examples/tree/master/gen2-depth-driven-focus#depth-driven-focus))

![Depth driven focus](https://user-images.githubusercontent.com/18037362/144228694-68344fce-8932-4c23-b2f0-601be59184b6.gif)

## Monocular Depth Estimation - Neural Network Based ([here](https://github.com/luxonis/oak-examples/tree/master/gen2-depth-mbnv2))

![Image example](https://user-images.githubusercontent.com/18037362/140496170-6e3ad321-7314-40cb-8cc0-f622464aa4bd.gif)

## Tutorial on How To Display High-Res Object Detections ([here](https://github.com/luxonis/oak-examples/tree/master/gen2-display-detections))

![edit_bb](https://user-images.githubusercontent.com/18037362/141347853-00a1c5ac-d473-4cf9-a9f5-bdf6271e8ebe.png)

## Running EfficientDet Object Detector On-Camera ([here](https://github.com/luxonis/oak-examples/tree/master/gen2-efficientDet))
...
## Running EfficientNet Image Classifier On-Camera ([here]([url](https://github.com/luxonis/oak-examples/tree/master/gen2-efficientnet-classification#efficientnet-b0)))

![result](https://user-images.githubusercontent.com/67831664/119170640-2b9a1d80-ba81-11eb-8a3f-a3837af38a73.jpg)

## Facial Expression (Emotion) Recognition On-Camera ([here](https://github.com/luxonis/oak-examples/tree/master/gen2-emotion-recognition#gen2-emotion-recognition))

![Demo](https://user-images.githubusercontent.com/18037362/140508779-f9b1465a-8bc1-48e0-8747-80cdb7f2e4fc.png)

## Face Detection On-Camera (libfacedetection) ([here](https://github.com/luxonis/oak-examples/tree/master/gen2-face-detection#gen2-face-detection-on-depthai))

![libfacedetection](https://github.com/luxonis/oak-examples/blob/master/gen2-face-detection/imgs/example.gif?raw=true)

## Face Recognition On-Camera ([here](https://github.com/luxonis/oak-examples/tree/master/gen2-face-recognition#face-recognition))
...
## Facial Landmarks On-Camera ([here](https://github.com/luxonis/oak-examples/tree/master/gen2-facemesh))

![Facial Landmarks](https://github.com/luxonis/oak-examples/blob/master/gen2-facemesh/imgs/example.gif?raw=true)

## Fire Detection On-Camera ([here](https://github.com/luxonis/oak-examples/tree/master/gen2-fire-detection#fire-detection))

![Fire Detection](https://github.com/luxonis/oak-examples/blob/master/gen2-fire-detection/images/fire_demo.gif?raw=true)

## Head Posture Detection On-Camera ([here](https://github.com/luxonis/oak-examples/tree/master/gen2-head-posture-detection#gen2-head-posture-detection))

![Head Pose Detection](https://user-images.githubusercontent.com/18037362/172148301-45adb7ce-3aab-478f-8cad-0c05f349ce50.gif)

## Human-Machine Safety Example On-Camera ([here](https://github.com/luxonis/oak-examples/tree/master/gen2-human-machine-safety#gen2-human-machine-safety))
...
## Human Skeletal Pose Estimation ([here](https://github.com/luxonis/oak-examples/tree/master/gen2-human-pose#gen2-pose-estimation-example))
...
## LaneNet Lane Segmentation On-Camera ([here](https://github.com/luxonis/oak-examples/tree/master/gen2-lanenet))

![LaneNet Lane Segmentation](https://github.com/luxonis/oak-examples/blob/master/gen2-lanenet/imgs/example.gif?raw=true)

## License Plate Recognition On-Camera ([here](https://github.com/luxonis/oak-examples/tree/master/gen2-license-plate-recognition#gen2-license-plates-recognition))
...
## Lossless Zooming (4K to 1080p Zoom/Crop) On-Camera ([here](https://github.com/luxonis/oak-examples/tree/master/gen2-lossless-zooming#lossless-zooming))
...
## Running Mask-RCNN On-Camera ([here](https://github.com/luxonis/oak-examples/tree/master/gen2-maskrcnn-resnet50#mask-r-cnn-on-depthai))

![Example](https://user-images.githubusercontent.com/56075061/145182204-af540962-f233-480c-82a0-56b2587e5072.gif)

## MegaDepth Neural Depth Running On-Camera ([here](https://github.com/luxonis/oak-examples/tree/master/gen2-mega-depth#gen2-megadepth-on-depthai))

[MegaDepth](https://github.com/luxonis/oak-examples/blob/master/gen2-mega-depth/imgs/example.gif?raw=true)

## MJPEG Streaming From On-Camera ([here](https://github.com/luxonis/oak-examples/tree/master/gen2-mjpeg-streaming#mjpeg-streaming-server))
...
## Class Agnostic Object Detector Running On-Camera ([here](https://github.com/luxonis/oak-examples/tree/master/gen2-mobile-object-localizer#gen2-mobile-object-localizer-on-depthai))

![Image example](https://user-images.githubusercontent.com/18037362/140496684-e886fc00-612d-44dd-a6fe-c0d47988246f.gif)

## How to Use Multiple Cameras Simultaneously ([here](https://github.com/luxonis/oak-examples/tree/master/gen2-multiple-devices#gen2-multiple-devices-per-host))
...
## How to Sync NN Data with Image Data for Custom Neural Networks ([here](https://github.com/luxonis/oak-examples/tree/master/gen2-nn-sync#gen2-nn-frame-sync))

![image](https://user-images.githubusercontent.com/5244214/104956823-36f31480-59cd-11eb-9568-64c0f0003dd0.gif)

## Optical Character Recognition in the Wild On-Camera ([here](https://github.com/luxonis/oak-examples/tree/master/gen2-ocr#how-to-run))
...
## Palm Detection On-Camera ([here](https://github.com/luxonis/oak-examples/tree/master/gen2-palm-detection#palm-detection))

![Palm Detection](https://github.com/luxonis/oak-examples/blob/master/gen2-palm-detection/images/palm_detection.gif?raw=true)

## Pedestrian Re-Identification ([here](https://github.com/luxonis/oak-examples/tree/master/gen2-pedestrian-reidentification#pedestrian-reidentification))
...
## People Counting On-Camera ([here](https://github.com/luxonis/oak-examples/tree/master/gen2-people-counter#gen2-people-counting))
...
## People Direction-Tracker and Counter ([here](https://github.com/luxonis/oak-examples/tree/master/gen2-people-tracker#gen2-people-tracker))

![demo](https://user-images.githubusercontent.com/18037362/145656510-94e12444-7524-47f9-a036-7ed8ee78fd7a.gif)

## Playing an On-Camera Encoded Stream on the Host ([here](https://github.com/luxonis/oak-examples/tree/master/gen2-play-encoded-stream#gen2-play-encoded-stream))

![Encoding demo](https://user-images.githubusercontent.com/59799831/132475640-6e9f8b7f-52f4-4f75-af81-86c7f6e45b94.gif)

## Recording and Playing Back Depth in RealSense -Compatible Format ([here](https://github.com/luxonis/oak-examples/tree/master/gen2-record-replay#record-and-replay))

![depth gif](https://user-images.githubusercontent.com/18037362/141661982-f206ed61-b505-4b17-8673-211a4029754b.gif)

## Road Segmentation On-Camera ([here](https://github.com/luxonis/oak-examples/tree/master/gen2-road-segmentation#gen2-road-segmentation-on-depthai))
...
## Roboflow Integration ([here](https://github.com/luxonis/oak-examples/tree/master/gen2-roboflow-integration#oak--roboflow-demo))

https://user-images.githubusercontent.com/26127866/147658296-23be4621-d37a-4fd6-a169-3ea414ffa636.mp4

## Social Distancing Example ([here](https://github.com/luxonis/oak-examples/tree/master/gen2-social-distancing#gen2-social-distancing))
...
## Text Blurring On-Device ([here](https://github.com/luxonis/oak-examples/tree/master/gen2-text-blur#gen2-text-blurring-on-depthai))

![Text Blurring](https://github.com/luxonis/oak-examples/blob/master/gen2-text-blur/imgs/example.gif?raw=true)

## Image Classification On-Device ([here](https://github.com/luxonis/oak-examples/tree/master/gen2-tf-image-classification#gen2-tensorflow-image-classification-example))
...
## Facial Key-point Triangulation On-Camera ([here](https://github.com/luxonis/oak-examples/tree/master/gen2-triangulation#gen2-triangulation---stereo-neural-inference-demo))

![Stereo Inference GIF](https://user-images.githubusercontent.com/59799831/132098832-70a2d0b9-1a30-4994-8dad-dc880a803fb3.gif)

## WebRTC Streaming Example ([here](https://github.com/luxonis/oak-examples/tree/master/gen2-webrtc-streaming#gen2-webrtc-streaming-example))
...
## YOLO V3 V4 V5 X P V8 V9 and 11 On-Camera ([here](https://github.com/luxonis/oak-examples/tree/master/gen2-yolo))
