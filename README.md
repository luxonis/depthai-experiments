...
<table border="0" style="border-collapse: collapse;">
  <tr>
    <td valign="top" width="600px" style="border: none;">
      <img src="apps/default-app/media/demo.gif" alt="Apps Demo" width="600">
    </td>
...
<table border="0" style="border-collapse: collapse;">
  <tr>
    <td valign="top" width="600px" style="border: none;">
      <img src="camera-controls/manual-camera-control/media/example.gif" alt="Camera Controls Demo" width="600">
    </td>
    <td valign="top" style="padding-left: 20px; border: none;">
...
<table border="0" style="border-collapse: collapse;">
  <tr>
    <td valign="top" width="600px" style="border: none;">
      <img src="depth-measurement/stereo-runtime-configuration/media/example.png" alt="Depth Measurement Demo" width="600">
    </td>
    <td valign="top" style="padding-left: 20px; border: none;">
...
<table border="0" style="border-collapse: collapse;">
  <tr>
    <td valign="top" width="600px" style="border: none;">
      <img src="neural-networks/object-detection/human-machine-safety/media/hms.gif" alt="Neural Networks Demo" width="600">
    </td>
    <td valign="top" style="padding-left: 20px; border: none;">
...
<table border="0" style="border-collapse: collapse;">
  <tr>
    <td valign="top" width="600px" style="border: none;">
      <img src="streaming/poe-mqtt/media/mqtt_client.gif" alt="Stream Manipulation Demo" width="600">
    </td>
    <td valign="top" style="padding-left: 20px; border: none;">
...
<table border="0" style="border-collapse: collapse;">
  <tr>
    <td valign="top" width="600px" style="border: none;">
      <img src="tutorials/qr-with-tiling/media/example.gif" alt="Tutorials Demo" width="600">
    </td>
    <td valign="top" style="padding-left: 20px; border: none;">
