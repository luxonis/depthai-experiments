...
"""
The code is the same as for YoloV3-tiny and YoloV4-tiny in docs (https://docs.luxonis.com/projects/api/en/latest/samples/Yolo/tiny_yolo/)
We adapt it to use it on our trained model with:
    * only one class,
    * custom input shape,
