...
with OakCamera(replay='people-tracking-above-03') as oak:
    ...
    tracker.config_tracker(track_labels=[1], tracker_type=dai.TrackerType.ZERO_TERM_COLOR_HISTOGRAM)
    ...
    oak.visualize(tracker.out.tracker, callback=cb, record_path='demo.mp4')
