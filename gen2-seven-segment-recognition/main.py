...
with dai.Device(pipeline) as device:
    ...
    while True:
        ...
        frame = cv2.putText(frame, f"FPS: {fps.fps():.1f}  " + "Pred " + pred, (20, 20), font, 0.5, (0,0,0), 3, cv2.LINE_AA)
        frame = cv2.putText(frame, f"FPS: {fps.fps():.1f}  " + "Pred " + pred, (20, 20), font, 0.5, (255,255,255), 1, cv2.LINE_AA)
