...
from depthai_sdk.managers import PipelineManager, NNetManager, PreviewManager, Previews, toTensorResult
...
pv = PreviewManager(display=[Previews.nnInput.name])
...
with dai.Device(pm.pipeline) as device:
    ...
    while True:
        ...
        print(output["DetectionOutput_647"], len(output["DetectionOutput_647"]))
