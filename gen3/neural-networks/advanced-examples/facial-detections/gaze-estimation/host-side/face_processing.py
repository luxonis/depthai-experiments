...
class FaceProcessing(dai.node.HostNode):
    ...
    def build(self, img_frames: dai.Node.Output, bboxes: dai.Node.Output) -> "FaceProcessing":
    ...
    def _send_outputs(self, land_data: dai.NNData, pose_data: dai.NNData, face_buffer: NumpyBuffer) -> None:
