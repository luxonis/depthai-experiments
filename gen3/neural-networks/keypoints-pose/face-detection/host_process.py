...
class HostProcess(dai.node.HostNode):
    ...
    def build(self, preview: dai.Node.Output, detection_network: dai.Node.Output, nn_width: int, nn_height: int, video_width: int, video_height: int) -> "HostProcess":
