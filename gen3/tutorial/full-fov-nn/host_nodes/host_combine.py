...
class CombineOutputs(dai.node.HostNode):
    ...
    def build(self, nn_manip : dai.Node.Output, crop_manip : dai.Node.Output, letterbox_manip : dai.Node.Output, 
              stretch_manip : dai.Node.Output, keyboard_input : dai.Node.Output | None = None) -> "CombineOutputs":
    ...
    def process(self, nn_manip : dai.ImgFrame, crop_manip : dai.ImgFrame, letterbox_manip : dai.ImgFrame, stretch_manip : dai.ImgFrame) -> None:
