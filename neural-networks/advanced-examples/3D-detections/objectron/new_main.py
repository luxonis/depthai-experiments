...
from utils.annotation_node_copy import AnnotationNode
...
with dai.Pipeline(device) as pipeline:
    ...
    # sync.keypoints_input.setMaxSize(10)

    # pose_nn.getOutput(0).link(sync.keypoints_input)
