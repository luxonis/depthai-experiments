...
with dai.Pipeline(device) as pipeline:
    ...
    detection_process_node.set_target_size(260, 260)
    ...
    emotion_recognition_node: ParsingNeuralNetwork = pipeline.create(ParsingNeuralNetwork).build(
        crop_node.out, "luxonis/emotion-recognition:260x260"
        )
