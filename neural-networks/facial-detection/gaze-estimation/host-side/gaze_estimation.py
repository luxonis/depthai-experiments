    ...
    def process(
        ...
        if self._debug:  # face
            for batch_index in range(batches):
                ...
                if (
                    batch_gaze is not None
                    and batch_left_bbox is not None
                    and batch_right_bbox is not None
                ):
                ...
                if not self._laser:
                    ...
                    if batch_left_bbox is not None:
                        cv2.rectangle(
                            debug_frame,
                            (batch_left_bbox[0], batch_left_bbox[1]),
                            (batch_left_bbox[2], batch_left_bbox[3]),
                            (245, 10, 10),
                            2,
                        )
                    if batch_right_bbox is not None:
                        cv2.rectangle(
                            debug_frame,
                            (batch_right_bbox[0], batch_right_bbox[1]),
                            (batch_right_bbox[2], batch_right_bbox[3]),
                            (245, 10, 10),
                            2,
                        )
