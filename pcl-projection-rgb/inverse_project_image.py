...
# Right camera            
M2 = np.array([[860.858642578125, 0.0,            649.8875732421875], 
...
T = np.array([-3.75, 0, 0.0001], np.float32) # cm 
...
# pcd.crop()
cam_coords[:, cam_coords[2] > 300] = float('inf') 
...
print('shape pf rgb_frame_ref_cloud')
...
pcd = pcl_converter.rgbd_to_projection(depth_rgb, color)
