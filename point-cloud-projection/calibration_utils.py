...
class StereoCalibration(object):
    ...
    def calibrate(self, filepath, square_size, out_filepath, right_intrinisc_file, flags):
        ...
        print(" writing right camera Intiniscs")
        ...
        with open(right_intrinisc_file, 'w') as fp:
