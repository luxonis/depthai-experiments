...
from depthai_sdk import OakCamera, Visualizer, DetectionPacket

NN_WIDTH, NN_HEIGHT = 300, 300


def callback(packet: DetectionPacket, visualizer_: Visualizer, **kwargs):
    frame = packet.frame
...
with OakCamera() as oak:
    ...
    oak.visualize(det_nn, callback=callback)
