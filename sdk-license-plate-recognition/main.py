...
def callback(ctx):
    ...
    for det in packet.img_detections.detections:
        ...
        bbox = NormalizeBoundingBox((300, 300), AspectRatioResizeMode.STRETCH).normalize(packet.frame, bbox)
...
with OakCamera(replay='chinese_traffic.mp4') as oak:
    ...
    det.config_nn(aspectRatioResizeMode=AspectRatioResizeMode.STRETCH)
    ...
    oak.visualize(lp_rec.out.main, callback=callback)
