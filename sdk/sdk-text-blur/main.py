...
NN_PATH = 'models/text_detection_db_480x640_openvino_2021.4_6shave.blob'
MAX_CANDIDATES = 75
MIN_SIZE = 1
THRESH = 0.01
BOX_THRESH = 0.2
...
def callback(ctx: CallbackContext):
    ...
    for bbox in boxes:
        ...
        bbox = NormalizeBoundingBox((NN_WIDTH, NN_HEIGHT), AspectRatioResizeMode.LETTERBOX).normalize(packet.frame,
                                                                                                      bbox)
