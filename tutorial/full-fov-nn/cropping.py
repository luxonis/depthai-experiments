...
with dai.Pipeline(device) as pipeline:
    ...
    cam_crop = cam.requestOutput(size=(512, 288), type=dai.ImgFrame.Type.BGR888i if platform == dai.Platform.RVC4 else dai.ImgFrame.Type.BGR888p, fps=25)

    nn = pipeline.create(dai.node.DetectionNetwork).build(cam_crop, nn_archive, confidenceThreshold=0.5)
