...
def setup_detection_pipeline(
    ...
    model_description = dai.NNModelDescription("mobilenet-ssd", platform=device_instance.getPlatformAsString())
...
def main():
    ...
    print(f"Found {len(available_devices_info)} DepthAI devices to configure for detection.")
